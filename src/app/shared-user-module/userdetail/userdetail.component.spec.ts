...
describe('UserdetailComponent', () => {
  ...
  // let sampleuserdata2 ={ id:"user1","firstName":"Saniddhya",lastName:"Nigam",age: 22,"login": "Sani1",password:"xyz22",isDeleted: true}
  // let sampleuserdata ={ id:"user1","firstName":"Saniddhya",lastName:"Nigam",age: 22,"login": "Sani1",password:"xyz22",isDeleted: false}
  beforeEach(async () => {
